...
```{r}
## Primer Problema: Tabla de Decisión Inventada
...
Este problema inventado demuestra cómo diferentes métodos de toma de decisiones bajo incertidumbre pueden sugerir diferentes estrategias dependiendo de si el escenario es favorable o desfavorable.
